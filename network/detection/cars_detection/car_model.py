...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python cars_detection.py train --dataset=D:/users/lacus/test/Mask_RCNN/customImages --weights=coco

    # Resume training a model that you had trained earlier
    python3 car.py train --dataset=/path/to/car/dataset --weights=last

    # Train a new model starting from ImageNet weightsd:
...
def detect_and_color_splash(model, image_path=None, video_path=None):
    ...
    if image_path:
        ...
        import cv2
        # Video capture
        VIDEO_SOURCE = "path_to_video_source"
